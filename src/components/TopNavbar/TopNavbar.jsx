                  ...
                  <TabPanels>
                    <TabPanel>
                      <Box className={style.buy} state={{ arr: resBuyArr }}>
                        <Checkbox
                          onChange={(e) => handleresbuy("Flat / Apartment")}
                          isChecked={resBuyArr.includes("Flat / Apartment")}
                          iconSize={"0px"}
                          colorScheme={"blue"}
                        >
                          Flat/Apartment
                        ...
                        <Checkbox
                          onChange={(e) =>
                            handleresbuy("Independent House / Villa")
                          }
                          isChecked={resBuyArr.includes(
                        ...
                        <Checkbox
                          onChange={(e) =>
                            handleresbuy("Independent / Builder Floor")
                          }
                          isChecked={resBuyArr.includes(
                        ...
                        <Checkbox
                          onChange={(e) => handleresbuy("Serviced Apartment")}
                          isChecked={resBuyArr.includes("Serviced Apartment")}
                          iconSize={"0px"}
                          colorScheme={"blue"}
                        >
                          Serviced Apartment
                        ...
                        <Checkbox
                          onChange={(e) => handleresbuy("Plot / Land")}
                          isChecked={resBuyArr.includes("Plot / Land")}
                          iconSize={"0px"}
                          colorScheme={"blue"}
                        >
                          Plot/Land
                        ...
                        <Checkbox
                          onChange={(e) =>
                            handleresbuy("1 RK / Studio Apartment")
                          }
                          isChecked={resBuyArr.includes(
                        ...
                        <Checkbox
                          onChange={(e) => handleresbuy("Farmhouse")}
                          isChecked={resBuyArr.includes("Farmhouse")}
                          iconSize={"0px"}
                          colorScheme={"blue"}
                        >
                          Farmhouse
                    ...
                    <TabPanel>
                      <Box className={style.buy}>
                        <Checkbox
                          onChange={(e) => handleCombuy(e.target.value)}
                          value={"Office"}
                          isChecked={comBuyArr.includes("Office")}
                          size={"md"}
                          color={"black"}
                        >
                          Office
                        ...
                        <Checkbox
                          onChange={() => handleCombuy("Retail")}
                          isChecked={comBuyArr.includes("Retail")}
                        >
                          Retail
                        </Checkbox>
                        <Checkbox
                          onChange={() => handleCombuy("Plot / Land")}
                          isChecked={comBuyArr.includes("Plot / Land")}
                        >
                          Plot / Land
                        </Checkbox>
                        <Checkbox
                          onChange={() => handleCombuy("Storage")}
                          isChecked={comBuyArr.includes("Storage")}
                        >
                          Storage
                        </Checkbox>
                        <Checkbox
                          onChange={() => handleCombuy("Industry")}
                          isChecked={comBuyArr.includes("Industry")}
                        >
                          Industry
                        </Checkbox>
                        <Checkbox
                          onChange={() => handleCombuy("Hospitality")}
                          isChecked={comBuyArr.includes("Hospitality")}
                        >
                          Hospitality
                        </Checkbox>
                      </Box>
                ...
                <Tabs variant="enclosed">
                  ...
                  <TabPanels>
                    <TabPanel>
                      <Box className={style.buy}>
                        <Checkbox
                          onChange={() => handleresrent("Flat / Apartment")}
                          isChecked={resRentArr.includes("Flat / Apartment")}
                          iconSize={"0px"}
                          colorScheme={"blue"}
                        >
                          Flat/Apartment
                        ...
                        <Checkbox
                          onChange={() =>
                            handleresrent("Independent House / villa")
                          }
                          isChecked={resRentArr.includes(
                            "Independent House / villa"
                          )}
                          iconSize={"0px"}
                          colorScheme={"blue"}
                        ...
                        <Checkbox
                          onChange={() =>
                            handleresrent("Independent / Builder Floor")
                          }
                          isChecked={resRentArr.includes(
                            "Independent / Builder Floor"
                          )}
                        ...
                        <Checkbox
                          onChange={() => handleresrent("Serviced Apartment")}
                          isChecked={resRentArr.includes("Serviced Apartment")}
                          iconSize={"0px"}
                          colorScheme={"blue"}
                        >
                          Serviced Apartment
                        ...
                        <Checkbox
                          onChange={() => handleresrent("Plot / Land")}
                          isChecked={resRentArr.includes("Plot / Land")}
                          iconSize={"0px"}
                          colorScheme={"blue"}
                        >
                          Plot/Land
                        ...
                        <Checkbox
                          onChange={() =>
                            handleresrent("1RK / Studio Apartment")
                          }
                          isChecked={resRentArr.includes(
                        ...
                        <Checkbox
                          onChange={() => handleresrent("Farmhouse")}
                          isChecked={resRentArr.includes("Farmhouse")}
                          iconSize={"0px"}
                          colorScheme={"blue"}
                        >
                          Farmhouse
                    ...
                    <TabPanel>
                      <Box className={style.buy}>
                        <Checkbox
                          onChange={() => handleComRent("Office")}
                          isChecked={comRentArr.includes("Office")}
                          size={"md"}
                          color={"black"}
                        >
                          {" "}
                        ...
                        <Checkbox
                          ...
                          isChecked={comRentArr.includes("Retail")}
                        >
                          Retail
                        </Checkbox>
                        <Checkbox
                          onChange={() => handleComRent("Plot / Land")}
                          isChecked={comRentArr.includes("Plot / Land")}
                        >
                          Plot/Land
                        </Checkbox>
                        <Checkbox
                          onChange={() => handleComRent("Storage")}
                          isChecked={comRentArr.includes("Storage")}
                        >
                          Storage
                        </Checkbox>
                        <Checkbox
                          onChange={() => handleComRent("Industry")}
                          isChecked={comRentArr.includes("Industry")}
                        >
                          Industry
                        </Checkbox>
                        <Checkbox
                          onChange={() => handleComRent("Hospitality")}
                          isChecked={comRentArr.includes("Hospitality")}
                        >
                          Hospitality
                        </Checkbox>
                      </Box>
