  ...
  return (
    <Box w={"90%"} margin={"auto"}>
      <Box textAlign={"justify"} w={"70%"} >  
        ...
        {/* <img src="" alt="" /> */}
        <Heading as='h4' size='md'> 1. VIRTUAL REALITY AND AUGMENTED REALITY </Heading>
        ...
        <Heading as='h4' size='md'>2. SOCIAL LISTENING</Heading>
        ...
        <Text fontSize={"md"} m={"20px 0"} >If you want to know more, read our social listening blog.</Text>

        <Heading as='h4' size='md'> 3. VIDEO CONTENT </Heading>
        ...
        <Heading as='h4' size='md'>4. SEO-OPTIMISED CONTENT</Heading>
        ...
        <Heading as='h4' size='md'>5. DIGITAL FIRST STRATEGY</Heading>
        ...
        <Heading as='h4' size='md'>HOW AMETHEUS CAN HELP?</Heading>
