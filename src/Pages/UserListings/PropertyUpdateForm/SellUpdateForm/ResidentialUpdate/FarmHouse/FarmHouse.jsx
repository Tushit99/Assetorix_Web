    ...
    > 
     <form onSubmit={handleSubmitData}>
      ...
      <Box className={style.location_form}>
        <Heading size={"lg"}>Edit your Farm House Details</Heading>
      ...
      {/* Property Detail */}
      <Box > 
        <Heading as={"h4"} size={"sm"} textAlign={"left"} marginTop={{base:10,md:5}}>
          Add Room Details
        </Heading>
        ...
        <Box display={"flex"} gap={{base:5,md:10}} marginTop={5} flexWrap={"wrap"}>
          <Checkbox 
...
export default FarmHouseUpdate;
