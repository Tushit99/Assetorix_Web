        ...
        <Box marginTop={6}>
          ...
          <Box textAlign={"left"} className={style.optional_box}>
            ...
            <Box className={style.grid}>
              ...
              <button
                className={
                  propertyAge == "1-5 years" ? style.setbtn : style.btn
                }
                borderRadius={"100px"}
                onClick={handlepropertyAge}
                value={"1-5 years"}
              ...
              <button
                className={
                  propertyAge == "5-10 years" ? style.setbtn : style.btn
                }
                borderRadius={"100px"}
                onClick={handlepropertyAge}
                value={"5-10 years"}
              ...
              <button
                className={
                  propertyAge == "10+ years" ? style.setbtn : style.btn
                }
                borderRadius={"100px"}
                onClick={handlepropertyAge}
                value={"10+ years"}
          ...
          <Box className={style.optional_box}>
            ...
            <Box>
              ...
              <button
                ...
                value={"Any"}
                className={
                  preferredAgreement == "Any" ? style.setbtn : style.btn
                }
              >
                Any
              </button>
          ...
          <Box className={style.optional_box}>
            ...
            <Box>
              ...
              <button
                onClick={handleMonthNotice}
                className={
                  noticePeriod == "2 months" ? style.setbtn : style.btn
                }
                value={"2 months"}
              >
                {" "}
              ...
              <button
                onClick={handleMonthNotice}
                className={
                  noticePeriod == "3 months" ? style.setbtn : style.btn
                }
                value={"3 months"}
              >
                {" "}
              ...
              <button
                onClick={handleMonthNotice}
                className={
                  noticePeriod == "4 months" ? style.setbtn : style.btn
                }
                value={"4 months"}
              >
                {" "}
              ...
              <button
                onClick={handleMonthNotice}
                className={
                  noticePeriod == "5 months" ? style.setbtn : style.btn
                }
                value={"5 months"}
              >
                {" "}
              ...
              <button
                onClick={handleMonthNotice}
                className={
                  noticePeriod == "6 months" ? style.setbtn : style.btn
                }
                value={"6 months"}
              >
                {" "}
