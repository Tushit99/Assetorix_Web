      ...
      <form onSubmit={handleSubmitData}>
              ...
              <Box>
                <Menu>
                  ...
                  >
                    ...
                    {Array.from(Array(Number(totalfloors)).keys()).map(
                      (e, i) => {
                        return (
                          <Checkbox
          ...
          <Box className={style.optional_box}>
            ...
            <Box>
              <button
                ...
                className={
                  fireNocCertificate == "Yes" ? style.setbtn : style.btn
                }
              >
                Yes
              </button>
              <button
                ...
                className={
                  fireNocCertificate == "No" ? style.setbtn : style.btn
                }
              >
                No
              </button>
        ...
        <Box className={style.optional_box}>
          ...
          <Box>
            ...
            <button
              className={
                amenities.includes("CCTV Surveillance")
                  ? style.setbtn
                  : style.btn
              }
              onClick={handleAminities}
