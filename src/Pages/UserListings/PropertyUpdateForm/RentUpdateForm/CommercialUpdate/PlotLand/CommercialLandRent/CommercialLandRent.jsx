...
const CommercialLandRentUpdate = () => {
  ...
  return (
    <Box className="perfectwidth" w={"94%"} padding={"0 20px"} margin={"auto"} boxShadow={"rgba(100, 100, 111, 0.2) 0px 7px 29px 0px"}>
      <form onSubmit={handleSubmitData}>
        ...
        <Box className={style.optional_box}>
          ...
          <Box display={"flex"} gap={"20px"} w={"300px"} >
            <Input type="text" variant='flushed' flex={1} maxLength={4} required value={facingwidth} onChange={(e) => {
              e.preventDefault();
