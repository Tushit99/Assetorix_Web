...
import { Box, Button, Heading, Input, Select, Tab, TabList, TabPanel, TabPanels, Tabs, Text } from '@chakra-ui/react';
                ...
                <Box>
                    ...
                    <Box className={style.inp_form_numbers}>
                        <Box textAlign={"left"} >
                            ...
                            <Input type="text" variant='flushed' padding={"0 2px"} placeholder={"Enter number of bedrooms"} />
                        </Box>
                        <Box textAlign={"left"} >
                            <Text> No. of Bathrooms </Text>
                            <Input type="text" variant='flushed' padding={"0 2px"} placeholder={"Enter number of bathrooms"} />
                        </Box>
                        <Box textAlign={"left"} >
                            <Text> No. of Balconies </Text>
                            <Input type="text" variant='flushed' padding={"0 2px"} placeholder={"Enter number of balconies"} />
                        </Box>
                    </Box>
                    <Box textAlign={"left"} >
                        <Heading as={"h3"} margin={"5px 0"} size={"md"} > Add Area Details </Heading>
                        <Text margin={"5px 0"} > Atleast one area type is mandatory </Text>
                        <Box className={style.select_land}>
                    ...
                    <Box className={style.optional_box}>
                        ...
                        <Box>
                            <Button>Puja Room</Button>
                            <Button> Studdy Room </Button>
