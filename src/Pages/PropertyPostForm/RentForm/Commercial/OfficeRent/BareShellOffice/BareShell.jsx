...
const BareShell = () => {
  ...
  const handleSubmitData = async (e) => {
    ...
    if (city && ownership && inclusivePrices && totalfloors) {
    ...
    <form onSubmit={handleSubmitData}>
      ...
      <Box>
        ...
        <Box textAlign={"left"} padding={"10px 0"}>
          ...
          <InputGroup w={400} margin={"10px 0"}>
            <Input
              ...
              onChange={(e) =>
                setminimumLeasable(NumericString(e.target.value))
              }
            />
            <Select
              value={areaPer}
        ...
        <Box className={style.optional_box}>
          ...
          <Box>
            ...
            <button
              ...
              className={
                wallConstructionStatus === "Brick walls"
                  ? style.setbtn
                  : style.btn
              }
              value={"Brick walls"}
            ...
            <button
              ...
              className={
                wallConstructionStatus === "Cemented walls"
                  ? style.setbtn
                  : style.btn
              }
            ...
            <button
              ...
              className={
                wallConstructionStatus === "Plastered walls"
                  ? style.setbtn
                  : style.btn
              }
        ...
        <Box className={style.optional_box}>
          ...
          <Box>
            <button
              ...
              className={doorConstructed === "Yes" ? style.setbtn : style.btn}
              value={"Yes"}
            >
              Yes
            </button>
            <button
              ...
              className={doorConstructed === "No" ? style.setbtn : style.btn}
              value={"No"}
            >
              No
            </button>
        ...
        <Box padding={"10px 0 8px 0"}>
          ...
          <Box display={"flex"} gap={10} padding={"12px 0"}>
            ...
            <button
              ...
              className={pantryType === "No Pantry" ? style.setbtn : style.btn}
            >
              No Pantry
            </button>
          </Box>
              ...
              <Menu>
                ...
                >
                  {floorNumber.length > 0
                    ? `${floorNumber.length} Floor Selected`
        ...
        <Box className={style.optional_box}>
          ...
          <Box
            display={securityDeposit == "None" ? "none" : "block"}
            marginTop={2}
          >
            <Input
              type="text"
