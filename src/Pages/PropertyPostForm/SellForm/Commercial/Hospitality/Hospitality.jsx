...
const Hospitality = () => {
  ...
  return (
    <div>
      <Heading size={"sm"} as={"h4"} textAlign={"left"} margin={"4px 0"}>
        What kind of Hospitality is it?
      </Heading>
      <Box display={"flex"} flexWrap={"wrap"} gap={4}>
        <button
          value={"Hotel/Resorts"}
          className={type == "Hotel/Resorts" ? style.setbtn : style.btn}
        ...
        <button
          ...
          className={
            type == "Guest-House/Banquet-Halls" ? style.setbtn : style.btn
          }
          onClick={(e) => setType(e.target.value)}
        >
