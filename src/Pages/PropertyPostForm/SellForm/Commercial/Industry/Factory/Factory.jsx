                ...
                <Box>
                    ...
                    <Box>
                        {additionalPrice && <>
                            ...
                            <Input type="text" w={"300px"} value={bookingAmount} maxLength={"12"} onChange={(e) => setBookingAmount(NumericString(e.target.value))} placeholder="Booking Amount" margin={"10px 0 0 0"} />
                        </>
                        }
                        <Heading
                            as={"h3"}
