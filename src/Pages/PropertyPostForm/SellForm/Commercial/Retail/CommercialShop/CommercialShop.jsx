          ...
          <Box>
            ...
            <Box textAlign={"left"}>
              ...
              <Box display={"flex"} alignItems={"center"}>
                <Input
                  type="text"
                  value={totalfloors}
                  placeholder="Enter total no. floor"
            ...
            <Box>
              ...
              <Box className={style.grid} gap={4}>
                ...
                <button
                  className={
                    ownership == "Leasehold" ? style.setbtn : style.btn
                  }
                  borderRadius={"100px"}
                  border={"1px solid rgba(113, 210, 255, 0.897)"}
                  margin={"8px 6px 0 0"}
            ...
            <Box>
              ...
              <Box display={"grid"} width={260} gap={2}>
                {investorsTendReturn == "" ? (
                  <button
                    className={style.tend_btn}
                    onClick={() => setinvestorsTendReturn("Yes")}
                  >
                    + Add Assured Returns
                  </button>
                ) : (
                  <Input
                    ...
                    value={assuredReturns}
                    onChange={(e) => setAssuredReturns(e.target.value)}
                  />
                )}
                {investorsTendGuarantee == "" ? (
                  <button
                    className={style.tend_btn}
                    onClick={() => setinvestorsTendGuarantee("Yes")}
                  >
                    + Add Lease Guarantee
                  </button>
                ) : (
